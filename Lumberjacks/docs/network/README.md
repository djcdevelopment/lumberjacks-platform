...
| What did the AoI testing actually learn, and why is none of it in the code? | [Area of interest findings](area-of-interest-findings.md) |
| I want to find the AoI capacity frontier — where do I start? | [AoI knee experiment brief](aoi-knee-experiment-brief.md) |
| How can a build be visible from far away without over-building distance? | [Landmark reach design](landmark-reach-design.md) |
