...
public static class ValheimAccessPolicy
{
    static readonly (string Method, string Prefix, ValheimCapability Required)[] Rules =
    {
        ...
        ("POST", "/valheim/zdo-journal/mutations", ValheimCapability.Producer),
        ("POST", "/valheim/zdo-journal/interest", ValheimCapability.Consumer),
        ("GET", "/valheim/zdo-journal/pending/", ValheimCapability.Consumer),
        ("POST", "/valheim/zdo-journal/ack", ValheimCapability.Consumer),
