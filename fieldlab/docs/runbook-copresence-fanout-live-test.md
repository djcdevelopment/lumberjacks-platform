...
- Seat gate open for 2 players (`POST /valheim/handshake/config {seat_capacity:0}` — ephemeral, resets
  on gateway restart; re-POST if the gateway bounced). See `FINDINGS-multiplayer-copresence-2026-07-21.md`.
