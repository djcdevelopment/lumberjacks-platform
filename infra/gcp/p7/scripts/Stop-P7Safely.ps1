...
test -n "$latest"
sudo jq -c '{schema,status,detail,completed_utc,world_name,was_running,world_saved_log_seen,db_bytes,fwl_bytes,interrupted_temp_files,stack_stop_exit}' "$latest"
'@
