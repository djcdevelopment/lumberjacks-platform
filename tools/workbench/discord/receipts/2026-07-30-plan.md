...
- Generated: 2026-07-30T08:54:53Z (UTC)
- Guild: `1531911987074957442`
- Channel: `#workbench` (forum)
- Plan hash: `23bc2b88476e`
...
| MCP mod channel | `10-thread-seed-mcp-mod-channel.md` | question | no | 1 | to create |
...
- **CREATE** "MCP mod channel" -- forum post from 10-thread-seed-mcp-mod-channel.md (1 message(s), tag: question)
...
```
python tools/workbench/discord/workbench_discord.py apply --yes --expect-plan 23bc2b88476e
```
